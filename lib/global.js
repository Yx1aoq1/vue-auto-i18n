...
global.logger = {
  ...
  info: function () {
    console.log(_chalk.default.cyan('[vue-i18n-cli] '), (0, _slice.default)([]).call(arguments).join(' '));
  },
  logWithTime: function () {
    info(_chalk.default.cyan('[vue-i18n-cli] ') + ' [' + (0, _dayjs.default)().format('YY.MM.DD HH:mm:ss') + '] ' + (0, _slice.default)([]).call(arguments).join(' '));
  }
}; // 配置文件名称
